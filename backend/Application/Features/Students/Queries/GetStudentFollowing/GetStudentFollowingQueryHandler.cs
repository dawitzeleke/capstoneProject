...
public class GetStudentFollowingQueryHandler : IRequestHandler<GetStudentFollowingQuery, List<TeacherDto>>
{
    ...
    public GetStudentFollowingQueryHandler(IFollowRepository followRepository, ITeacherRepository teacherRepository)
    {
    ...
    {
        var follows = await _followRepository.GetByStudentIdAsync(request.StudentId);
